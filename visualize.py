...
def _main():
    ...
    def fill_area(map_array, top_left, bottom_right, value):
        map_array[top_left[0]:bottom_right[0],
                  top_left[1]:bottom_right[1]] = value

    # Заполняем карту объектами
    fill_area(game_map, (2, 2), (5, 5), PointType.ZOMBIE.value)
    fill_area(game_map, (6, 6), (10, 10), PointType.WALL.value)
    fill_area(game_map, (12, 2), (15, 5), PointType.MY_BASE.value)
    game_map[13, 3] = PointType.MY_CAPITAL.value
